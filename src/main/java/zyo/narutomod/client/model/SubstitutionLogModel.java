...
public class SubstitutionLogModel<T extends SubstitutionLogEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(NarutoMod.MODID, "substitution_log"), "main");
